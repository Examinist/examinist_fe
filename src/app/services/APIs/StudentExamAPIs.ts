import { IStudentAnswer, IStudentDetailedExam, IStudentExam } from "../../types/StudentExam";
...
export interface IStudentExamResponse
  extends IResponse<IStudentExamData> {};
...
export const submitStudentExamApi = async (id:number, payload: IStudentExamPayload) => {
