  ...
  return (
    <Grid container direction="column" marginLeft={5} spacing={1}>
      ...
      examQuestion.exam_question.question.question_type.name ==
        ...
        examQuestion.exam_question.question.choices?.map((choice, index) => {
          return (
            <Grid
              key={choice.id!}
              item
            ...
            >
              <Grid item>
                <Circle
                  color={
                    examQuestion.answer?.includes(choice.choice!)
        ...
        <Stack spacing={2}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ p: 2 }}>
              {examQuestion.exam_question.question.correct_answers?.[0].answer}
            </Typography>
          </Box>
        </Stack>
      )}
